...
All benchmarks below were measured on **RTX 5070 Ti** (Blackwell GB203, 70 SMs), PyTorch 2.9.1, CUDA 12.8, FP16, all in python. Timing uses CUDA events with verified warmup (adaptive 20–50 warmup iterations + stability check with CV < 5% before measurement, trimmed mean of 10–100 measured repeats). All benchmarks also assumes perfect/near zero memory bandwidth overhead (in a full training loop, CRA will most likely perform better).
